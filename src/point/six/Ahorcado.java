...
//		int random=(int) (Math.random()*2);
	...
	public void turnoDelSiguienteJugador() {
		if (this.turno == 2) {
			this.turno = 1;
	...
	public void arriegar(String palabra, int idAdversario) {
		if (idAdversario == p1.getId() && palabra.equals(p1.getPalabra())) {
			p1.setLifes(0);
			this.ganador=p2;
		}
		if (idAdversario == p2.getId() && palabra.equals(p2.getPalabra())) {
			p2.setLifes(0);
			this.ganador=p1;
		}
	}
